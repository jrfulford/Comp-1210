...
/**
   *returns list of Decagonal Prisms.
   *
   *@return ArrayList.
   */
   ...
   /**
   *reads file and creates a list of Decagonal Prisms.
   *
   *@return ArrayList.
   ...
   */
   public DecagonalPrismList readFile(String fileNameIn) 
      ...
      DecagonalPrismList myDecagonalPrismList 
         = new DecagonalPrismList(dListName, myList);
         
      return myDecagonalPrismList;
   }
   /**
   *adds Decagonal Prism to the prismList.
   *
   *@param labelIn used.
   *@param edgeIn used.
   *@param heightIn used.
   */
   public void addDecagonalPrism(String labelIn, double edgeIn,
      ...
      DecagonalPrism d = new DecagonalPrism(labelIn, edgeIn, 
         heightIn);
      
      prismList.add(d);
   }
   /**
   *finds Decagonal Prism in prismList.
   *
   *@param labelIn used.
   *@return DecagonalPrism.
   */
   ...
   /**
   *finds and deletes a Decagonal Prism.
   *
   *@param labelIn used.
   *@return DecagonalPrism.
   */
   public DecagonalPrism deleteDecagonalPrism(String labelIn) {
      ...
      int index = 0;
      for (DecagonalPrism d : prismList) {
         if (labelIn.equalsIgnoreCase(d.getLabel())) {
            index = prismList.indexOf(d);
   ...
   /**
   *finds and edits a Decagonal Prism.
   *
   *@param labelIn used.
   *@param edgeIn used.
   *@param heightIn used.
