...
*/
   @Test public void totalSurfaceAreaNonZeroTest() {
      ...
      Assert.assertEquals("totalSurfaceAreaNonZeroTest failed",
         54.12435565298214, tList.totalSurfaceArea(), 0.000001);
...
*/
   @Test public void averageSurfaceAreaNonZeroTest() {
      ...
      Assert.assertEquals("averageSurfaceAreaNonZeroTest failed",
         18.04145188432738, tList.averageSurfaceArea(), 0.000001);
...
/**
   ...
   */
   @Test public void toStringTest() {
      ...
      TriangularPrism[] tArray = new TriangularPrism[10];
      tArray[0] = new TriangularPrism("Example1", 1, 1);
      tArray[1] = new TriangularPrism("Example2", 1, 1);
      tArray[2] = new TriangularPrism("Example3", 1, 1);
      
      TriangularPrismList tList = 
         new TriangularPrismList("Test List", tArray, 3);
   
      Assert.assertEquals("toStringTest", false, 
         tList.toString().contains("with triangle edge of "
         + "1.0 units and prism height of 1.0 units"));
   ...
   */
   @Test public void findTriangularPrismValidEntryTest() {
      ...
      Assert.assertEquals("findTriangularPrismTestValidEntry failed",
          tArray[1], tList.findTriangularPrism("EXAMPLE 2"));
